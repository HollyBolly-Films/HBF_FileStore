...
### Installation
#### Deploy on Heroku
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/HollyBolly-Films/HBF_FileStore)</br>
...
#### Deploy in your VPS
````bash
git clone https://github.com/HollyBolly-Films/HBF_FileStore
cd File-Sharing-Bot
